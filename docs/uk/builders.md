...
| пропустити аргумент або передати `null` | поле не надсилається — і реєстр видаляє те, що тримав |
...
причому **кожна команда відповідає 1000** — блок, надісланий без `org`, повертається вже без
...
// Перенести контакт до Львова й очистити організацію, лишивши решту такою, як була.
$client->contact()->updateBuilder('C-0001')
